...
export let RibbonComponent: DefineVueComponent<RibbonModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ...
            tagMapper: {"e-ribbon-tabs":{"e-ribbon-tab":{"e-ribbon-groups":{"e-ribbon-group":{"e-ribbon-collections":{"e-ribbon-collection":{"e-ribbon-items":"e-ribbon-item"}}}}}},"e-ribbon-contextual-tabs":"e-ribbon-contextual-tab"} as { [key: string]: Object },
